...
const JOBS = [
  {
    ...
    focus: ["Events", "Vendors", "Customer Experience", "Marketing"],
    responsibilities: [
      "Manage event space bookings, schedules, and logistics",
      "Coordinate vendors, catering, and food services",
      "Arrange and oversee AV and technical requirements for events",
      "Ensure smooth event execution and high guest satisfaction",
      "Build relationships with clients and repeat customers",
      "Plan and execute event promotions (online & offline)",
      "Collaborate with content creators to capture event moments (photos/videos)",
      "Support social media campaigns before, during, and after events",
      "Assist in creating marketing materials for upcoming events",
    ],
    idealFor: [
      "Organized, detail-oriented, and people-focused individuals",
      "Experience in event planning, hospitality, or customer service",
      "Strong communication and customer relationship skills",
      "Basic understanding of social media (Instagram, TikTok, Facebook)",
      "Interest in branding, promotions, or event marketing (a plus)",
    ],
  },
  {
    ...
    badge: "Full-time / Part-time",
    badgeColor: "#7C3AED",
    focus: ["VR", "Gaming Technology", "Customer Support", "Digital Content"],
    responsibilities: [
      "Manage and maintain VR systems and gaming equipment",
      "Assist guests with immersive VR experiences and troubleshooting",
      "Support VR events, tournaments, and group bookings",
      "Learn and work with advanced gaming technologies",
      "Ensure safety, cleanliness, and operational efficiency",
      "Capture engaging content (photos/videos) of gameplay and guest experiences",
      "Create short-form content (Reels/TikTok) to promote the VR zone",
      "Manage or assist with daily social media posts and engagement",
      "Help plan promotional campaigns, events, or gaming challenges",
      "Track customer engagement and suggest improvements",
    ],
    idealFor: [
      "VR, gaming, or tech enthusiasts",
      "Strong communication and customer service skills",
      "AV setup or event organizing experience (a plus)",
      "Creative mindset with interest in content creation",
      "Familiarity with social media platforms and trends",
      "Basic video editing or design skills (bonus)",
    ],
  },
  {
    icon: <CameraAlt sx={{ fontSize: 36 }} />,
    emoji: "🎬",
    title: "Content Creator & Social Media Specialist",
    badge: "Part-time / Contract",
    badgeColor: "#F59E0B",
    focus: ["Content Creation", "Social Media", "Marketing", "Photography & Video"],
    responsibilities: [
      "Create engaging content (videos, reels, posts) for events and VR experiences",
      "Manage social media accounts and posting schedules",
      "Develop marketing campaigns to increase foot traffic and bookings",
      "Capture live events and customer experiences",
      "Analyze engagement metrics and improve content strategy",
    ],
    idealFor: [
      "Creative individuals with strong storytelling skills",
      "Experience with Instagram, TikTok, YouTube",
      "Basic video editing (CapCut, Final Cut Pro, Adobe, etc.)",
      "Passion for events, gaming, or entertainment",
    ],
  },
];
